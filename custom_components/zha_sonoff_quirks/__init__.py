...
This integration ships custom ZHA quirks for SONOFF Zigbee devices. Its only
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    `from . import quirks` above), so there is nothing left to do here.
    """
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    Quirk registration cannot be cleanly undone (the registry has no public
